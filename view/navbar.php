<div class="hamburger-menu">
    ...
    <ul class="menu__box">
      ...
      <li><a class="menu__item" href="http://localhost/Podcast_Callo/podcast">Tous les podcasts</a></li>
      ...
      <li><a class="menu__item" href="http://localhost/Podcast_Callo/contact">Nous contacter</a></li>
